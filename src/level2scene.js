...
export default class Level2Scene extends Phaser.Scene {
    ...
    update() {
		...
		if (this.jumpKey.isDown && player.body.onFloor()) {
			...
			this.soundManager.playJumpSound(); // Ajouter le son de saut
		}
	...
	showGameOverUI() {
		this.isDead = true;
		this.soundManager.playGameOverSound(); // Ajouter le son de game over
		this.physics.world.pause();
	...
	showVictoryUI() {
		this.soundManager.playVictorySound(); // Ajouter le son de victoire
		this.physics.world.pause();
		this.input.keyboard.enabled = false;
